...
class AnnotatedGymCompete(gym.Wrapper):
    ...
    def __init__(self, env, env_name, agent_a_type, agent_a_path, agent_b_type, agent_b_path,
        ...
        # Text overlay
        self.font = ImageFont.truetype('/home/xkw5132/Downloads/arial.ttf', font_size)
        self.font_bold = ImageFont.truetype('/home/xkw5132/Downloads/arial.ttf', font_size)
